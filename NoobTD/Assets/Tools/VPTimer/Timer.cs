...
namespace NoobTD
{
	...
	public class Timer
	{
			...
			bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
		{
			...
			{
				ClockManager managerInScene = Object.FindObjectOfType<ClockManager>();
				...
				else
				{
					...
					Timer._manager = managerObject.AddComponent<ClockManager>();
		...
		/// scene manually.
		/// </summary>
		private class ClockManager : MonoBehaviour
		{
