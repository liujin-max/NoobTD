...
namespace NoobTD
{
    ...
    // public class AndroidPlatformManager :ISDKApi
    {

        // //private AndroidJavaClass AndroidClass;
        // //private AndroidJavaObject AndroidActivity;

        // public AndroidPlatformManager()
        // {
        //     //AndroidClass = new AndroidJavaClass("com.GongTou.SoulLand.UnityPlayerActivity");
        //     //AndroidActivity = AndroidClass.GetStatic<AndroidJavaObject>("currentActivity");
        // }
