...
public class JumpingNumberTextComponent : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        _numberSize = new Vector2(_numbers[0].rectTransform.sizeDelta.x, _numbers[0].rectTransform.sizeDelta.y + 20);
    }

    public void AddNumber(Text go)
    {
        _numbers.Add(go);
    }

    public void AddAcNumber(Text go)
    {
        _unactiveNumbers.Add(go);
    }
    ...
    {
        int x = UnityEngine.Random.Range(10000, 10000000);
        print(x);
        Change(0, x);
    }
