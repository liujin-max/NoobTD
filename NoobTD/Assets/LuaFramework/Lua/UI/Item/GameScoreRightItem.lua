local GameScoreRightItem = {}

function GameScoreRightItem:Awake(items)
    self.GO             = items["This"]
...
function GameScoreRightItem:Init(score, description)
...
function GameScoreRightItem:Show()
    local ani  = self.GO:GetComponent("Animation")
    ani:Play("ScoreRightShow")
...
function GameScoreRightItem:OnDestroy()
