...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(NoobTD.UIEventListener)),
        _GT(typeof(NoobTD.UISimpleEventListener)),
        _GT(typeof(TMPro.TextMeshPro)),
        _GT(typeof(TMPro.TextMeshProUGUI)),
        _GT(typeof(NoobTD.LuaItems)),             
        _GT(typeof(Canvas)),             
       ...
       _GT(typeof(Slider)),
        ...
        // _GT(typeof(LuaBehaviour)),
         ...
         _GT(typeof(NoobTD.AssetManager)),
         _GT(typeof(NoobTD.EventManager)),
         _GT(typeof(NoobTD.Timer)),
		 _GT(typeof(NoobTD.ConstManager)),
         _GT(typeof(NoobTD.LevelManager)),
         _GT(typeof(NoobTD.AdsManager)),

        _GT(typeof(FoodWar.LootFly)),
        _GT(typeof(FoodWar.LandControl)),
        _GT(typeof(JumpingNumberTextComponent)),
        ...
        _GT(typeof(NoobTD.PlayerPrefsManager)),
        _GT(typeof(NoobTD.FileUtility)),
        _GT(typeof(NoobTD.Avatar)),
        _GT(typeof(NoobTD.GameUtil)),
        _GT(typeof(NoobTD.PageView)),
        _GT(typeof(NoobTD.ImageGray)),
        _GT(typeof(NoobTD.BGM)),
    };
